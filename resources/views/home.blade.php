...
<div class="hero-slider">
            <div class="single-slide" style="background-image: url(img/slide1.png)">
                <div class="inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slide-content">
                                    <h2>Faustino Ollisco</h2>
                                    <p>Senador por Chuquisaca 20-25</p>
                                    <div class="slide-btn">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="single-portfolio col-md-4">
                <div class="inner">
                    <div class="portfolio-img">
                        <img src="img/portfolio6.jpg" alt="portfolio-image">
                        <div class="hover-content">
                            <div>
                                <a href="#" class="button">View Case Study</a>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="faq-img text-center">
                    <img src="img/fag-img.png" alt="faq">
                </div>
            </div>
        </div>
    </div>
